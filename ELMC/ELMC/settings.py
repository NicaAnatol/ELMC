...
WSGI_APPLICATION = 'ELMC.wsgi.application'
...
cad_files_dir = os.path.join(MEDIA_ROOT, 'cad_files')
...
USER_THUMBNAILS_DIR = os.path.join(THUMBNAIL_DIR, 'user_thumbnails')
...
# Security settings for production (comentează aceste linii în development)
